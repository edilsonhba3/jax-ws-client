 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://localhost:8080/jax-ws-server/services/v1/EmployeeService", wsdlLocation = "http://localhost:8080/jax-ws-server/EmployeeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://localhost:8080/jax-ws-server/services/v1/EmployeeService", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jax-ws-server/EmployeeService?wsdl");
    ...
    public EmployeeServiceImpl getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://localhost:8080/jax-ws-server/services/v1/EmployeeService", "EmployeeServiceImplPort"), EmployeeServiceImpl.class);
    }
    ...
    public EmployeeServiceImpl getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:8080/jax-ws-server/services/v1/EmployeeService", "EmployeeServiceImplPort"), EmployeeServiceImpl.class, features);
    }
